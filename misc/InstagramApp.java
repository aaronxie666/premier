        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    final String id = jsonObj.getJSONObject("user").getString("id");
                    final String user = jsonObj.getJSONObject("user").getString(
                            "username");
                    final String name = jsonObj.getJSONObject("user").getString(
                            "full_name");
                    final String profile_picture = jsonObj.getJSONObject("user")
...
//    }
    ...
    public String getProfilePicture() {return mSession.getProfilePicture();}
