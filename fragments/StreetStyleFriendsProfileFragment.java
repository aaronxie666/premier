...
public class StreetStyleFriendsProfileFragment extends Fragment {
    ...
    public StreetStyleFriendsProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (AllLoginActivity.userType == UserType.userType.facebookUser
            ...
            rootView = inflater.inflate(R.layout.fragment_street_style_friends_profile, container, false);
...
//                        followSelectedUser();
    ...
    private void showFollowersDialog() {
        Dialog followersDialog = new Dialog(getActivity(), android.R.style.Theme_Holo_Light_Dialog_NoActionBar);
