 ...
 * Association: ICN Button press in AboutPremierFragment
 */

public class ICNFragment extends Fragment {

    protected RecyclerView recyclerView;
    private ArrayList<HomeLatestVideosDataModel> appsList;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View rootView = inflater.inflate(R.layout.fragment_about_premier_icnapps,  container, false);
    ...
    private void populateRecyclerView() {
        ParseQuery<ParseObject> query = ParseQuery.getQuery("ICN_Apps");
...
//                        String video_link = (String) j.get("link");
                        appsList.add(new HomeLatestVideosDataModel(image.getUrl(), ""));
                    }
                }
                else {
                ...
                RecyclerViewAdapterHomeLatestVideos adapter = new RecyclerViewAdapterHomeLatestVideos(getActivity(), appsList, "ICN");
